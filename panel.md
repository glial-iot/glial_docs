...
Список скриптов представляет из себя таблицу, в верхней части которой расположены элементы управления:  
...
Панель управления Glue может быть также открыта непосредственно при обращении на инстанс Glue (HTTP запрос на "хост:порт/", на котором работает Glue).  
